...
def configuracionIndividuos():
    ...
    entrada_salida.entrada("entrada.csv")
...
def configuracionAlgoritmo_Experimento1():
	...
	No es necesario que se modifiquen de forma excesiva la configuración de la práctica anterior,
	al tratarse del mismo problema. Se pueden realizar ajustes si se observa un comportamiento más interesante.
	'''
