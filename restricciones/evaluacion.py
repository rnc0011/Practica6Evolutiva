...
En el caso de la función de restriciones, se necesita además implementar las funciones siguientes:
'''  
...
def distance(individual):
	# Devolverá un valor real

'''
La explicación a estas nuevas funciones se puede encontrar en: 
